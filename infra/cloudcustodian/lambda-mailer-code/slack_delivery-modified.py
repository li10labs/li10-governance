...
class SlackDelivery:
    def __init__(self, config, logger, email_handler):
        ...
        self.config = config
        self.logger = logger
        self.email_handler = email_handler # adding back to use slack://owners
